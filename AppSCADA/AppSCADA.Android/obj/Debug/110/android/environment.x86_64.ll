...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"beed9b17-3366-420d-908a-22e74a21b801\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [16 x i8] c"com.companyname\00", align 16
...
@__DSOCacheEntry_name.1 = internal constant [20 x i8] c"libHarfBuzzSharp.so\00", align 16
...
@dso_cache = local_unnamed_addr global [36 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 1
	%struct.DSOCacheEntry {
